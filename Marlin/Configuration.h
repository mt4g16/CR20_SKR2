...
#define STRING_CONFIG_H_AUTHOR "Roberto Holmes" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "The Pronter"
...
#define FIL_RUNOUT_PIN 2 // Creality CR20-S stock sensor (maybe)
